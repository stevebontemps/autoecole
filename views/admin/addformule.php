            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Formulaire d'ajout d'une Formule
                        </h1>
                    </div>
                    <div class="col-lg-12">
                        <?php
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form" action="" method="post" name="myFormAddFormule" onsubmit="return validate();" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-default" name="create">Envoyer</button>
